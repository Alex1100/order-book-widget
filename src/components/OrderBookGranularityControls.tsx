      ...
      <Container className="fd-row jc-space-between align-itm-fs">
        ...
        >
          ...
          <Popover.Dropdown
            bg="#111214"
            variant="unstyled"
            styles={{ dropdown: { border: 'solid 2px grey' } }}
          >
            <GranularityControl
              label={'nSigFigs'}
              ...
              tooltipLabel={
                'Number of significant figures - controls the precision of price display in the order book. Higher values show more decimal places.'
              }
            ...
            <GranularityControl
              ...
              rootContainerClassNames="flex fd-col"
              tooltipLabel={
                'Price grouping interval - controls how orders are aggregated by price level. Smaller values show more granular price levels, larger values group orders into wider price buckets for cleaner display.'
              }
              iconProps={{ width: '70%', height: '70%' }}
